...
$result = mysql_query("SELECT * FROM socio AS s INNER JOIN pagmensalidade as p ON s.socio_id = p.pag_mens_socio INNER JOIN mespagamento as m on p.pag_mens_mes=m.mespag_id where pag_mens_status =0 ORDER BY pag_mens_mes");
$data = date("d/m/Y");
$nome = "recibo.pdf";
$html = "<html><body>"
